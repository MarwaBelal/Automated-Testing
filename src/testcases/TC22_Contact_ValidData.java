...
public class TC22_Contact_ValidData {
	public static void main(String[] args) {
		...
		driver.findElement(By.name("first_name")).sendKeys("marwa");
		driver.findElement(By.name("last_name")).clear();
		driver.findElement(By.name("last_name")).sendKeys("belal");
		driver.findElement(By.name("email")).clear();
		driver.findElement(By.name("email")).sendKeys("marwa@yahoo.com");
